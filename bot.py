    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Main Channel", url="https://t.me/Korean_Drama_In_Hindi_Dubbed_4u")
                    ],
                    [
                    ...
                    [
                        InlineKeyboardButton("Support Group", url="https://t.me/KDrama_Chats_and_Discussions_4u"),
                        InlineKeyboardButton("Facebook ID", url="https://www.facebook.com/MExAk1b")
                    ]
                ]
            )
        )
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        try:
            ...
            share_link = f"https://t.me/{Config.BOT_USERNAME}?start=Akib_{str_to_b64(file_er_id)}"
...
async def button(bot: Client, cmd: CallbackQuery):
    ...
    if "aboutbot" in cb_data:
                ...
                [
                    [
                        InlineKeyboardButton("Source Codes of Bot",
                                             url="https://github.com/MExAkib/FileStoreBotWithURL")
                    ],
                    [
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. [Contact](https://t.me/THExAkib)",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="Something went Wrong. [Contact](https://t.me/THExAkib)",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
        ...
        if Config.UPDATES_CHANNEL is None:
            await cmd.answer("Sorry Sir, You didn't Set any Main Channel!", show_alert=True)
            return
        ...
        try:
            ...
            await cmd.answer("User Banned from Main Channel!", show_alert=True)
